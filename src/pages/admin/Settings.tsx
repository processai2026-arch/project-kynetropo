...
export default function Settings() {
  ...
  const handleSaveBusiness = async () => {
    ...
    } catch (err) { toast.error(err instanceof Error ? err.message : "Failed to update business info"); }
  ...
  const handleUpdatePassword = async () => {
    ...
    } catch (err) { toast.error(err instanceof Error ? err.message : "Failed to update password. Check current password is correct."); }
