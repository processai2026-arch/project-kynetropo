...
export default function Pitches() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      if (editing) { await opsPitchesApi.update(editing.id, form as Partial<OpsPitch>); toast.success("Pitch updated"); }
      else         { await opsPitchesApi.create(form as Partial<OpsPitch>); toast.success("Pitch added"); }
