 ...
 *
 *   php database/legacy/migrate_sales_tasks.php
 *
 * Creates the new tables from 121_create_sales_tasks.sql and adds the columns the
...
// ── 1. New tables ───────────────────────────────────────────────────────────
$sqlFile = dirname(__DIR__) . '/121_create_sales_tasks.sql';
if (!is_file($sqlFile)) {
    fwrite(STDERR, "[tasks] database/121_create_sales_tasks.sql is missing\n");
    exit(1);
}
